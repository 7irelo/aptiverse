...
namespace Aptiverse.Wellbeing.Domain.Models.Wellbeing
{
    ...
    public class DiaryEntry : IEntityTimestamps
    {
        ...
        // AI-analysis fields, populated later by wellbeing processing. Default to
        // empty (not null): the columns are NOT NULL, and the create path leaves
        // these unset, which was violating the constraint on save.
