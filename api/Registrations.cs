...
namespace Aptiverse.Auth
{
    public static class Registrations
    {
        ...
        public static IServiceCollection AddIdentityServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            // Google OAuth — only register when credentials are configured.
            // Skipping in dev avoids the OptionsValidationException that
            // OAuth's RequiredAttribute throws for empty ClientId/Secret.
